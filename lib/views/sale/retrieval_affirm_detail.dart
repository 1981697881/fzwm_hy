        ...
        if (orderDate.length > 0) {
          ...
          for(var value in orderDate){
            ...
            arr.add({
              ...
              "name": "FMaterial",
              "isHide": false,
              "value": {"label": value[6] + "- (" + value[5] + ")", "value": value[5],"barcode": [],"kingDeeCode": [],"surplus": value[12],"scanCode": []}
            });
            arr.add({
              "title": "规格型号",
              "isHide": false,
