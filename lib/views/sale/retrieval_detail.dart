...
class _RetrievalDetailState extends State<RetrievalDetail> {
  ...
  getStockList() async {
    ...
    for(var element in stockListObj){
      this.stockList.add(element[1]);
    }
    setState(() {
    ...
    if (orderDate.length > 0) {
      ...
      orderDate.forEach((value) {
        ...
        arr.add({
          ...
          "name": "FExpiryDate",
          "isHide": value[31] != true,
          "value": {"label": value[30]==null?'':value[30].substring(0, 10), "value": value[30]==null?'':value[30].substring(0, 10)}
        });
        hobby.add(arr);
      });
      setState(() {
