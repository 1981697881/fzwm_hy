    ...
    if (orderDate.length > 0) {
      ...
      orderDate.forEach((value) {
        ...
        arr.add({
          "title": "生产日期",
          "name": "FProduceDate",
          "isHide": value[30] != true,
          "value": {"label": value[28]==null?'':value[28].substring(0, 10), "value": value[28]==null?'':value[28].substring(0, 10)}
        });
        arr.add({
          "title": "有效期至",
          "name": "FExpiryDate",
          "isHide": value[30] != true,
          "value": {"label": value[29]==null?'':value[29].substring(0, 10), "value": value[29]==null?'':value[29].substring(0, 10)}
        });
        hobby.add(arr);
      });
      setState(() {
                  ...
                  for (int i = 0; i < this.hobby.length; i++) {
                    if (this.hobby[i][3]['value']['value'] != '0') {
                      ...
                      for(int j = 0;j<kingDeeCode.length;j++){
                        ...
                        codeFEntityItem['FProduceDate'] = orderDate[i][28]['value']['value'];
                        codeFEntityItem['FExpiryDate'] = orderDate[i][29]['value']['value'];
