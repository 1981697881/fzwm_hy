...
import 'package:fzwm_hy/views/production/return_affirm_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;

final String _fontFamily = Platform.isWindows ? "Roboto" : "";

class ReturnAffirmPage extends StatefulWidget {
  ReturnAffirmPage({Key ?key}) : super(key: key);

  @override
  _ReturnGoodsPageState createState() => _ReturnGoodsPageState();
}

class _ReturnGoodsPageState extends State<ReturnAffirmPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    userMap['FieldKeys'] =
    'FBillNo,FPrdOrgId.FNumber,FPrdOrgId.FName,FDate,FEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FStockOrgId.FNumber,FStockOrgId.FName,FUnitId.FNumber,FUnitId.FName,FAPPQty,FApproveDate,FQty,FID';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ReturnAffirmDetail(FBillNo:this.hobby[i][0]['value']
                            // 路由参数
                          );
                        },
                      ),
