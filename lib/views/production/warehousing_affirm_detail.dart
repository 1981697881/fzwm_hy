...
class WarehousingAffirmDetail extends StatefulWidget {
  ...
  @override
  _WarehousingAffirmDetailState createState() =>
      _WarehousingAffirmDetailState(FBillNo);
}

class _WarehousingAffirmDetailState extends State<WarehousingAffirmDetail> {
  ...
  getOrderList() async {
    ...
    if(stockFlex.length>0) {
      ...
      if (stockRes.length > 0) {
        userMap['FieldKeys'] =
        'FBillNo,FPrdOrgId.FNumber,FPrdOrgId.FName,FDate,FEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FStockOrgId.FNumber,FStockOrgId.FName,FUnitId.FNumber,FUnitId.FName,FMustQty,FSrcBillNo,FID,FMaterialId.FIsBatchManage,FStockId.FNumber,FStockId.FName,FStockUnitID.FNumber,FRealQty,FInStockType,FOwnerId0.FNumber,FDocumentStatus,FProduceDate,FExpiryDate,FMaterialId.FIsKFPeriod,FStockID.FIsOpenLocation,FStockLocId.'+stockRes[0][4] +'.FName,FLot.FNumber';
        Map<String, dynamic> dataMap = Map();
        dataMap['data'] = userMap;
        ...
        if (orderDate.length > 0) {
          ...
          for(var value in orderDate){
            ...
            arr.add({
              ...
              "value": {"label": value[28], "value": value[28]}
            });
            if (value[27]!= null) {
              arr.add({
                "title": "仓位",
