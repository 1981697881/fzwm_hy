...
import 'package:fzwm_hy/views/production/replenishment_affirm_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;

final String _fontFamily = Platform.isWindows ? "Roboto" : "";

class ReplenishmentAffirmPage extends StatefulWidget {
  ReplenishmentAffirmPage({Key ?key}) : super(key: key);

  @override
  _ReturnGoodsPageState createState() => _ReturnGoodsPageState();
}

class _ReturnGoodsPageState extends State<ReplenishmentAffirmPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    userMap['FieldKeys'] =
    'FBillNo,FPrdOrgId.FNumber,FPrdOrgId.FName,FDate,FEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FStockOrgId.FNumber,FStockOrgId.FName,FUnitId.FNumber,FUnitId.FName,FAppQty,FApproveDate,FActualQty,FID';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ReplenishmentAffirmDetail(FBillNo:this.hobby[i][0]['value']
                            // 路由参数
                          );
                        },
                      ),
