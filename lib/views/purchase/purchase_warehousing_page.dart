  ...
  getOrderList() async {
    ...
    if(this.isScan){
      if (this.keyWord != '') {
        ...
        "FBillNo like '%"+keyWord+"%' and FCloseStatus = 'A' and FRemainStockINQty>0";
      }
    }else{
      if (this.keyWord != '') {
        userMap['FilterString'] =/*and FRemainStockINQty>0*/
        ...
        userMap['FilterString'] =/*and FRemainStockINQty>0*/
        "FBillNo like '%"+keyWord+"%' and FCloseStatus = 'A' and FDate>= '$startDate' and FDate <= '$endDate' and FRemainStockINQty>0";
      }
    }
    this.isScan = false;
    ...
    userMap['FieldKeys'] =
    'FBillNo,FSupplierId.FNumber,FSupplierId.FName,FDate,FDetailEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FPurOrgId.FNumber,FPurOrgId.FName,FUnitId.FNumber,FUnitId.FActlandQty,FQty,FSrcBillNo,FID';
