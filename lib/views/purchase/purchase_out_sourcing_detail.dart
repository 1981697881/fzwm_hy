...
class PurchaseOutSourcingDetail extends StatefulWidget {
  var FBillNo;

  PurchaseOutSourcingDetail({Key ?key, @required this.FBillNo}) : super(key: key);

  @override
  _PurchaseOutSourcingDetailState createState() => _PurchaseOutSourcingDetailState(FBillNo);
}

class _PurchaseOutSourcingDetailState extends State<PurchaseOutSourcingDetail> {
  ...
  var fOrgID;
  var fBarCodeList;
  _PurchaseOutSourcingDetailState(FBillNo) {
    if (FBillNo != null) {
  ...
  getOrderList() async {
    ...
    /*_onEvent("rS4GuhddcEFEvSmlcNFjAtxm2vFej9cMprp+v8IEavh9BLgADkWBno@Q7q7UCICJ");*/
  }
  ...
  saveOrder() async {
    ...
    if (this.hobby.length > 0) {
      ...
      *//*Model['FDescription'] = this._remarkContent.text;*//*
      ...
      print(jsonEncode(dataMap));
     var dataPromise=jsonEncode(dataMap);
