...
import 'package:fzwm_hy/views/purchase/purchase_out_sourcing_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';
import 'purchase_warehousing_detail.dart';

class PurchaseOutSourcingPage extends StatefulWidget {
  PurchaseOutSourcingPage({Key ?key}) : super(key: key);

  @override
  _PurchaseOutSourcingPageState createState() => _PurchaseOutSourcingPageState();
}

class _PurchaseOutSourcingPageState extends State<PurchaseOutSourcingPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return PurchaseOutSourcingDetail(
