...
import 'package:fzwm_hy/model/authorize_entity.dart';
import 'package:fzwm_hy/model/currency_entity.dart';
import 'package:fzwm_hy/model/login_entity.dart';
import 'package:fzwm_hy/http/api_response.dart';
import 'package:fzwm_hy/views/index/index_page.dart';
                    ...
                    children: <Widget>[
                      Expanded(
                        child: RaisedButton(
                          ...
                          onPressed: () async {
                            if (this.acctidContent.text != '' &&
                                this.urlContent.text != '' &&
                                this.passwordContent.text != '' &&
                                this.usernameContent.text != '') {
                              sharedPreferences.setString(
                                  'url', this.urlContent.text);
                              sharedPreferences.setString(
                                  'acctId', this.acctidContent.text);
                              /*sharedPreferences.setString('lcid', this.lcidContent.text);*/
                              sharedPreferences.setString(
                                  'username', this.usernameContent.text);
                              sharedPreferences.setString(
                                  'password', this.passwordContent.text);
        ...
        onPressed: () async {
          ...
          if (_formKey.currentState!.validate()) {
            ...
            if (this.acctidContent.text != '' &&
              ...
              map['lcid'] = "2052";
              map['password'] = sharedPreferences.getString('password').trim();
                  ...
                  sharedPreferences.setString('FWorkShopName', resUser[0][3]);*/
                    ...
                    if (author.data!.data.fStatus == "0") {
                      ...
                      ToastUtil.errorDialog(
                          context, author.data!.data.fMessage);
                    }
                  } else {
                    if (!resUser[0][0]['Result']['ResponseStatus']
                        ['IsSuccess']) {
                      ToastUtil.showInfo(resUser[0][0]['Result']
