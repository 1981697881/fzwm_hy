...
import 'package:fzwm_hy/views/stock/allocation_affirm_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;

import 'call_out_affirm_detail.dart';

class CallOutAffirmPage extends StatefulWidget {
  CallOutAffirmPage({Key ?key}) : super(key: key);

  @override
  _CallOutAffirmPageState createState() => _CallOutAffirmPageState();
}

class _CallOutAffirmPageState extends State<CallOutAffirmPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
