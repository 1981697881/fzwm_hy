...
class CallInAffirmDetail extends StatefulWidget {
  var FBillNo;

  CallInAffirmDetail({Key? key, @required this.FBillNo}) : super(key: key);

  @override
  _CallInAffirmDetailState createState() => _CallInAffirmDetailState(FBillNo);
}

class _CallInAffirmDetailState extends State<CallInAffirmDetail> {
  ...
  _CallInAffirmDetailState(FBillNo) {
    if (FBillNo != null) {
